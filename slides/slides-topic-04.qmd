...
subtitle: "<span style = 'font-size: 100%;'> Topic 04: Version Control </span>"
...
<center>[Chris/r-bloggers.com](https://www.r-bloggers.com/2018/08/structuring-r-projects/)</center>
:::
:::
...
<center>[phdcomics.com](http://phdcomics.com/comics/archive.php?comicid=1531%22%3Ecreativity%3C/a%3E.%3C!--more--%3E%3C/p%3E)</center>
...
![[Linus Torvalds](https://en.wikipedia.org/wiki/Linus_Torvalds)](figs/linus-torvalds.jpeg){width="300"}
...
-   My [website](https://davi-moreira.github.io/) lives there. And this [course](https://github.com/davi-moreira/2024Summer1_dsc_emory_qtm_350) does, too.
:::
:::
:::
...
9.  Let's edit the `notes.txt` file one more time.
10. Finally, let's check if the `notes.txt` file is being tracked.
...
-   Also check:
    ...
    -   [A Successful Git Branching Model](https://nvie.com/posts/a-successful-git-branching-model/) -[Learn Git Branching](https://learngitbranching.js.org/)
:::
:::
